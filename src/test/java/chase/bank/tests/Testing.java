...
public class Testing extends Base_class {
	...
	public void creditCardPageTest() throws InterruptedException {
		...
		applicantDetailsPage.applicantInfoSteps("Natalie", "Lopez", "JR", "01/02/1994", "Ashley Lopez", "SOCIAL_SECURITY_NUMBER", "000-11-2222", "DOMESTIC", "2301 Westchester Ave", "10462", "Bronx", "NY", "Jasminelopez@hotmail.com", "123-321-1234");
